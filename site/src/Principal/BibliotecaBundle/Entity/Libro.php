 ...
 *
 * @ORM\Entity()
 * @ORM\Table(name="Libro", indexes={@ORM\Index(name="fk_Libro_Autor_idx", columns={"Autor_idAutor"})})
 */
class Libro
{
    /**
     ...
     * @ORM\JoinColumn(name="Autor_idAutor", referencedColumnName="id")
     */
    protected $autor;
     ...
     *
     * @param integer $Autor_idAutor
     * @return \Principal\BibliotecaBundle\Entity\Libro
     */
    public function setAutorIdAutor($Autor_idAutor)
    {
    ...
    {
        return array('id', 'Nombre', 'Pagina', 'Annio', 'Licencia', 'Sinopsis', 'Aprobado', 'Archivo', 'Foto', 'Autor_idAutor');
    }
}
